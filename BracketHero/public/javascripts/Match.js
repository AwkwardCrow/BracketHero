//players (1-4)
//state (finished or unfinished)
//game count (will reference players?)
//result (winner(s) and loser(s))
//position (used to calculate which players should enter a match for single/double)
